...
public class NewsArrayAdapter extends ArrayAdapter<ESPNNewsArticle> {


    public NewsArrayAdapter(Activity context, ArrayList<ESPNNewsArticle> arr) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ESPNNewsArticle currentNewsItem = getItem(position);
        ...
        ImageView iconView = (ImageView) itemView.findViewById(R.id.picture);
        // Get the image resource ID from the current AndroidFlavor object and
        // set the image to iconView
        iconView.setImageDrawable(currentNewsItem.getmImageResourceId());
